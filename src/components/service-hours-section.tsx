              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                  ...
                  <span className="font-medium text-gray-900 dark:text-white">
                    {businessHours.pickup.find(h => h.day === 1)?.openTime} - {businessHours.pickup.find(h => h.day === 1)?.closeTime}
                  </span>
                </div>
                <div className="flex justify-between items-center py-2">
                  ...
                  <span className="font-medium text-gray-900 dark:text-white">
                    {businessHours.pickup.find(h => h.day === 6)?.openTime} - {businessHours.pickup.find(h => h.day === 6)?.closeTime}
                  </span>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                  ...
                  <span className="font-medium text-gray-900 dark:text-white">
                    {businessHours.delivery.find(h => h.day === 1)?.openTime} - {businessHours.delivery.find(h => h.day === 1)?.closeTime}
                  </span>
                </div>
                <div className="flex justify-between items-center py-2">
                  <span className="text-gray-600 dark:text-gray-400">
                  ...
                  <span className="font-medium text-gray-900 dark:text-white">
                    {businessHours.delivery.find(h => h.day === 5)?.openTime} - {businessHours.delivery.find(h => h.day === 5)?.closeTime}
                  </span>
                </div>
              </div>
            </CardContent>
